...
'''
    import asyncio
    from thirdparty.python.repl import start_dict_server
...
'''
    from thirdparty.python.repl import start_dict_client
...
'''
    import asyncio
    import thirdparty.python.repl as __sandbox__
    import thirdparty.python.repl.mymodule as mymodule
    if __name__ == "__main__":
...
'''
    ...
    exec_client.py:
        ...
        ```python
        import asyncio
        from thirdparty.python.repl import exec_file
