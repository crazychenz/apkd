...
class BreakpointInfo():
    ...
    async def set_breakpoint(self):
        ...
        if self.class_signature not in self.dbg.classes_by_signature:
            ...
            print(f"Configuring breakpoint for: {jvm_to_java(self.class_signature)}.{self.method_name}{self.method_signature}.")
            ...
            if self.method_key in self.class_info.methods_by_signature:
                print(f"Enabling breakpoint for: {jvm_to_java(self.class_signature)}.{self.method_name}{self.method_signature}.")
                self.method_info = self.class_info.methods_by_signature[self.method_key]
