...
class Debugger():
    ...
    async def single_step(self, threadID, step_depth):
        ...
        self.jdwp.register_event_handler(reqid, Debugger.handle_step_event, (self,))
    ...
    async def handle_deferred_breakpoint_class_prepare(event, composite, args):
        ...
        await Debugger.handle_class_prepare(event, composite, dbg)
        ...
        if class_signature in dbg.classes_by_signature:
            ...
            if method_signature in classInfo.methods_by_signature:
                ...
                dbg.jdwp.register_event_handler(reqid, Debugger.handle_breakpoint_event, (dbg,))
    ...
    async def enable_deferred_breakpoint(self, class_signature, method_signature, bytecode_index=0):
        ...
        self.jdwp.register_event_handler(reqid, Debugger.handle_deferred_breakpoint_class_prepare, (self, class_signature, method_signature, bytecode_index))
