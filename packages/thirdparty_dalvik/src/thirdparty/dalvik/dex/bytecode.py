...
def p_30t(data: bytes, offset: int = 0):
    return {
        'op': data[0+offset],
        'aaaalo': int.from_bytes(data[2+offset:4+offset], "little"),
        'aaaahi': int.from_bytes(data[4+offset:6+offset], "little"),
    }, offset + 6
parser['30t'] = p_30t
...
def p_31i(data: bytes, offset: int = 0):
    return {
        'op': data[0+offset],
        'aa': data[1+offset],
        'bbbblo': int.from_bytes(data[2+offset:4+offset], "little"),
        'bbbbhi': int.from_bytes(data[4+offset:6+offset], "little"),
    }, offset + 6
parser['31i'] = p_31i
parser['31t'] = p_31i
parser['31c'] = p_31i
